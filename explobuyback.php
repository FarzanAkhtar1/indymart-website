...
<html>
	<head>
		<title>Indymart - Salvage Buyback</title>
		<meta charset="utf-8" />
	...
	<body class="is-preload">
		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<h1><a href="jinx.php">Indybro's Exploration Buyback</a></h1>
					<p>Explore to your heart's content</p>
				</div>
			...
			<section class="wrapper">
				<div class="inner">
					<header class="special">
						<h2>How to use</h2>
						<p><b>As of 00:01 EVE Time on 29/04/2020, I will no longer be accepting contracts. I thank you all for your business. Please mail me in-game or on Slack any questions.</b></p>
						<p>Input an evepraisal link into the box. Press the button to generate your quote. Create the contract in-game to "indybro"</p>
						<p>Accepting contracts in Brave structures in Brave space. Will consider Legacy on a case by case basis, PM me to discuss.</p>
						
					</header>
					
								<form action="explobuyback.php" method="post">
    ...
    */
    ...
    for ($i = 0; $i < $length; $i++){
        try{
            ...
            $rate = $conn->query("SELECT `COL 2` from `ExploBuyback` WHERE `COL 1` = \"$name\"");
    ...
    echo "Indybro will pay: ".number_format($Total,2)."<br>";
    echo "I reserve the right to reject any orders";
