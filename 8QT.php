...
<form action="8QT.php" method="post">
Collateral: <input type="number" name="collateral" max="10000000000"><br>
Volume (360k m3 max, 60,000 m3 max from Jita): <input type="text" name="volume" max="360000" pattern="^\d*(\.\d{0,2})?$"><br>
...
if ($_POST["collateral"] > 0 && $_POST["volume"] > 0 && $_POST["volume"] <360000.01) {
    echo "Reward (Jita to 8QT): ".number_format(max(20000000,((58/1000 * 0.85 * $_POST["collateral"]) + (max($collatRatio, $volumeRatio)*100000000))*1.02))."<br>";
    echo "Reward (Moro/Badivefi to 8QT): ".number_format(max(20000000,((max($collatRatio, $volumeRatio)*100000000))*1.02))."<br>";
    echo "<br>";
    ...
    echo "Destination: 8QT-H4<br>";
    echo "Reward: See above";
};
?>
</body>
</html>